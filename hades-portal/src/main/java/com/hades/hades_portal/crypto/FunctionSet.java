...
public class FunctionSet {
    ...
    public static void xor(
            RandomAccessFile in,
            RandomAccessFile temp,String key)
    {
    ...
    public static void shuffle(RandomAccessFile in,
    ...
    public static void rounds(RandomAccessFile in,
                              RandomAccessFile out,
                              String key,int shiftby,
                              int round)		//round Encryption/decryption
    {
